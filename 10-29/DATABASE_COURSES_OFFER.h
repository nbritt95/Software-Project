...
vector<vector<string>> COURSE_NUMBER{
	...
	{"0"}, //editing courses to match UHD course catelog
	{ "1410","2410" }, // there are 2 classes in the computer science: Key COMPUTER
	{ "1301","1404" }  // there are 2 classes in Math major
